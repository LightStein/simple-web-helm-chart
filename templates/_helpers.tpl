...
{{- printf "%s-serviceaccount" (default (include "simple-web.fullname" .) .Values.serviceAccount.name) }}
{{- else }}
{{- printf "%s-serviceaccount" (default "default" .Values.serviceAccount.name) }}
{{- end }}
{{- end }}
